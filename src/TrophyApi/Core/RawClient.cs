...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::TrophyApi.Core.ApiResponse> SendRequestAsync(
        global::TrophyApi.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::TrophyApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        if (!isRetryableContent || maxRetries == 0)
        {
            var response = await httpClient
                ...
                .ConfigureAwait(false);
            return new global::TrophyApi.Core.ApiResponse
            {
    ...
    private static string BuildUrl(global::TrophyApi.Core.BaseRequest request)
    {
