...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<TrophyApi.Core.ApiResponse> MakeRequestAsync(
        TrophyApi.Core.BaseRequest request,
    ...
    internal async Task<TrophyApi.Core.ApiResponse> SendRequestAsync(
        TrophyApi.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<TrophyApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new TrophyApi.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(TrophyApi.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(TrophyApi.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use TrophyApi.Core.ApiResponse instead.")]
    internal record ApiResponse : TrophyApi.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use TrophyApi.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : TrophyApi.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use TrophyApi.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : TrophyApi.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use TrophyApi.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : TrophyApi.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use TrophyApi.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : TrophyApi.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use TrophyApi.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : TrophyApi.Core.StreamRequest;
}
